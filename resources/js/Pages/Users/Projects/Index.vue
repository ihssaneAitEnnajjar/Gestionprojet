...
<template>
  <div>
    ...
    <UserLayout>
      ...
      <!-- New Project button -->
      <div class="flex justify-between">
          <a href="/users/projects/create" class="px-3 py-2 text-white font-semibold bg-oceaned hover:bg-indigo-700 rounded flex">
    ...
    <div>
        ...
        <div class="mt-6">
          <Table>
            ...
            <template #default>
              <TableRow v-for="project in managedProjects" :key="project.id" class="border-b">
              ...
              <TableDataCell class="space-x-4 action-column">
                <div class="action-wrapper">
                  <Link :href="route('users.projects.edit', { id: project.id })" class="text-black hover:text-black">Edit</Link>
